...
sap.ui.define([
	"sap/m/library",
	"sap/m/ListBase",
	"compRT_App/Combined/Light/util/Box",
	"sap/ui/Device",
	 ...
	 */
	var BoxContainerList = ListBase.extend("compRT_App.Combined.Light.util.BoxContainerList", { metadata : {
		properties: {
			 ...
			 */
			boxesPerRowConfig: { type: "string", group: "Behavior", defaultValue: "XL7 L6 M4 S2" }
		}
	}});
