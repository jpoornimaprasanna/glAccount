...
sap.ui.define([
	"sap/ui/core/Control",
	"compRT_App/Combined/Light/util/BoxContainerList",
	"compRT_App/Combined/Light/util/BoxContainerRenderer"
	 ...
	 */
	var BoxContainer = Control.extend("compRT_App.Combined.Light.util.BoxContainer", {
		metadata: {
			properties: {
				 ...
				 */
				boxesPerRowConfig: {
					type: "sap.tnt.BoxesPerRowConfig",
					group: "Behavior",
					defaultValue: "XL7 L6 M4 S2"
				}
			},
			...
			aggregations: {
				 ...
				 */
				boxes: {
					type: "compRT_App.Combined.Light.util.Box",
					multiple: true,
					singularName: "box",
					bindable: "bindable",
					forwarding: {
	...
	BoxContainer.prototype.removeSelections = function () {
		var oList;
	...
	BoxContainer.prototype.selectAllBox = function () {
		var oList;
	...
	BoxContainer.prototype.getItems = function () {
		var oList = this.getAggregation("_list");
		if (oList) {
			return oList.getItems();
		}
	};
	BoxContainer.prototype.getBindingContext = function () {
		var oList = this.getAggregation("_list");
		if (oList) {
	...
	["setHeaderText", "getHeaderText", "setGrowing", "getGrowing",
		...
		"setBoxesPerRowConfig", "getBoxesPerRowConfig"
